...
export function Erzbrau(props) {
    ...
    const obj = useLoader(OBJLoader, '/Erzbrau/Erzbrau.obj')

    // Load textures
    const diffuseMap = useLoader(TextureLoader, '/Erzbrau/tex_u1_v1_diffuse.jpg')
    const normalMap = useLoader(TextureLoader, '/Erzbrau/tex_u1_v1_normal.jpg')
