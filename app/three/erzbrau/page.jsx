...
const Erzbrau = dynamic(() => import('@/components/canvas/Erzbrau').then((mod) => mod.Erzbrau), { ssr: false })
        ...
        <>
            <div className='z-10 mx-auto flex w-full flex-col flex-wrap items-center md:flex-row  lg:w-4/5'>
                ...
                <div className='flex w-full flex-col items-start justify-center p-12 text-center md:w-2/5 md:text-left'>
                    <h2 className='mb-3 text-3xl font-bold leading-none text-gray-800'>a sticker from a brewery in Vienna.</h2>
